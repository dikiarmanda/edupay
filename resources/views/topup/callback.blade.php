...
@section('content')
  <div class="mb-18 w-full p-4">
    <!-- Header -->
    <x-header title="Detail Top Up" subtitle="Pantau status dan rincian transaksi Anda"
      backUrl="{{ route('topup.index') }}" />
    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        @if ($detail)
          ...
          <div class="mb-5 flex items-center justify-between">
            <div class="flex items-center gap-2">
              <span class="{{ $badge }} inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-xs">
      ...
      <div class="mt-5">
        <x-button href="{{ route('topup.index') }}" type="primary" class="w-full">
