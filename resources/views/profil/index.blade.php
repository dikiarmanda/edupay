  ...
  <div class="px-4 py-6">
    ...
    <div class="mb-6 rounded-xl bg-white p-6 shadow-sm">
      <div class="text-center">
        ...
        <h2 class="mb-1 text-xl font-bold text-gray-900">Moch Fauzan</h2>
        <p class="mb-4 text-gray-500">Siswa Kelas XII IPA 1</p>
        <div class="rounded-lg bg-purple-50 p-3">
          <p class="text-sm text-gray-600">NIS: 1234567890</p>
          <p class="text-sm text-gray-600">Email: moch.fauzan@school.edu</p>
        </div>
      </div>
    </div>
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-purple-100">
              <i data-lucide="edit" class="h-5 w-5 text-purple-600"></i>
            </div>
            <div>
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-green-100">
              <i data-lucide="key" class="h-5 w-5 text-green-600"></i>
            </div>
            <div>
